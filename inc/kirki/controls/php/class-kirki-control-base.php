	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'valhalla' ),
				'remove'               => esc_html__( 'Remove', 'valhalla' ),
				'default'              => esc_html__( 'Default', 'valhalla' ),
				'selectFile'           => esc_html__( 'Select File', 'valhalla' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'valhalla' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'valhalla' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'valhalla' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'valhalla' ),
			)
		);
