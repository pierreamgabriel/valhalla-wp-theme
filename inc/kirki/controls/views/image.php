...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'valhalla' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'valhalla' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'valhalla' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'valhalla' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'valhalla' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'valhalla' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'valhalla' ); ?>',
} );
#>
