...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'valhalla' ),
				'change'       => esc_html__( 'Change image', 'valhalla' ),
				'default'      => esc_html__( 'Default', 'valhalla' ),
				'remove'       => esc_html__( 'Remove', 'valhalla' ),
				'placeholder'  => esc_html__( 'No image selected', 'valhalla' ),
				'frame_title'  => esc_html__( 'Select image', 'valhalla' ),
				'frame_button' => esc_html__( 'Choose image', 'valhalla' ),
			)
		);
	}
